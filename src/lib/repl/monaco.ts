...
export function createMonacoTypeDownloader(tsconfig: languages.typescript.CompilerOptions) {
  ...
  const methods = {
    ...
    // Watchers
    watchTsconfig(cb: (tsconfig: languages.typescript.CompilerOptions) => void) {
